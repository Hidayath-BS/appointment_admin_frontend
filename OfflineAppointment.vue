<template>
  <v-flex xs12 sm12>
      ...
      <v-spacer></v-spacer>
      <v-flex xs12 md4 lg4>
        <v-text-field type="text" v-model="mrdNumber" class="fields"  label="MRD Number"></v-text-field>
      </v-flex>
    </v-layout>
    <v-layout row>
          <v-flex xs12 sm4>
    ...
    <v-layout row wrap>
        ...
        <v-layout row>
            <v-flex xs12>
               ...
               <v-card-text>
                ...
                <div v-if="slots.length > 0 || branchSlots.length > 0 || doctorSlots.length > 0">
       ...
       <br><hr><br> <h4><u>Clinical Details</u></h4><br>
            ...
            <v-layout row>
                <v-flex xs5>
                <v-subheader>Are you allergic to any Drug? &nbsp;
